...
1. Make sure your backend (FastAPI) is running on http://localhost:8000
...
The frontend will automatically fetch paginated and sorted exchange rates from the backend.
